...
public class DienThoai extends DrawerBaseActivity implements adapter_recyclerview.UserCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tennguoidung_admin.isEmpty()){
            ...
            GridLayoutManager gridLayoutManager = new GridLayoutManager(DienThoai.this,2);
            ...
            LinearLayoutManager linearLayoutManager =new LinearLayoutManager(DienThoai.this,LinearLayoutManager.VERTICAL,false);
    ...
    private void AnhXa() {
        ...
        DatabaseReference lapTopRef = databaseRef.child("Dien_Thoai");
